...
if command -v devp2p >/dev/null 2>&1 then echo "OK: devp2p command in PATH" else { echo "Please install devp2p"; exit 1; } fi
if command -v ethkey >/dev/null 2>&1 then echo "OK: ethkey command in PATH" else { echo "Please install ethkey"; exit 1; } fi
